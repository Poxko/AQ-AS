...
static int partizione(Richiesta *array, int basso, int alto,
...
static void quickSort(Richiesta *array, int basso, int alto,
                      ComparatoreRichieste confronta)
{
...
static void merge(Richiesta *array, Richiesta *temporaneo,
...
static void mergeSort(Richiesta *array, Richiesta *temporaneo,
