...
/* Legge un intero con validazione minima */
...
static void menuFiltri(const Richiesta *richieste, int numeroRichieste)
{
    ...
    do {
        ...
        switch (scelta) {
            ...
            case 2:
                if (leggiStato(&stato)) {
                    numeroFiltrate = filtraPerStato(richieste, numeroRichieste, risultati, stato);
            ...
            case 3:
                if (leggiPriorita(&priorita)) {
                    numeroFiltrate = filtraPerPriorita(richieste, numeroRichieste, risultati, priorita);
                    mostraRisultatiFiltro(risultati, numeroFiltrate);
                } else {
                ...
                break;
            case 4:
                if (leggiStringa("Nome cliente (anche parziale): ", nomeCliente, sizeof(nomeCliente))) {
                    numeroFiltrate = filtraPerCliente(richieste, numeroRichieste, risultati, nomeCliente);
                    mostraRisultatiFiltro(risultati, numeroFiltrate);
                } else {
...
static void menuStatistiche(const Richiesta *richieste, int numeroRichieste)
{
    ...
    do {
        ...
        switch (scelta) {
            case 1:
                if (leggiStringa("Tipologia dispositivo: ", dispositivo, sizeof(dispositivo))) {
